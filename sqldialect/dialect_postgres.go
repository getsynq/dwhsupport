...
func (d *PostgresDialect) UnquoteIdent(text string) (string, bool) {
...
func (d *PostgresDialect) StringLength(expr Expr) Expr {
	return Fn("LENGTH", expr)
}

func (d *PostgresDialect) FormatLimit(rowsSql string) string {
