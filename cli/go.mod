module github.com/getsynq/dwhsupport/cli

go 1.25.5

replace github.com/getsynq/dwhsupport => ../

require (
	github.com/getsynq/dwhsupport v0.0.0-00010101000000-000000000000
...
require (
	...
	buf.build/gen/go/getsynq/api/protocolbuffers/go v1.36.11-20260714162129-d61afe5c46b6.1 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/glue v1.140.1 // indirect
	...
	github.com/databricks/databricks-sdk-go v0.118.0 // indirect
