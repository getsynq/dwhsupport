...
func (m *MockScrapper) QueryShape(ctx context.Context, sql string) ([]*QueryShapeColumn, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryShape", ctx, sql)
	ret0, _ := ret[0].([]*QueryShapeColumn)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockScrapperMockRecorder) QueryShape(ctx, sql any) *MockScrapperQueryShapeCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryShape", reflect.TypeOf((*MockScrapper)(nil).QueryShape), ctx, sql)
	return &MockScrapperQueryShapeCall{Call: call}
}
...
func (m *MockScrapper) QueryTableConstraints(ctx context.Context) ([]*TableConstraintRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryTableConstraints", ctx)
...
func (mr *MockScrapperMockRecorder) QueryTableConstraints(ctx any) *MockScrapperQueryTableConstraintsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryTableConstraints", reflect.TypeOf((*MockScrapper)(nil).QueryTableConstraints), ctx)
