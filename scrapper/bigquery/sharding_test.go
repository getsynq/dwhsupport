...
type BigQueryShardingSuite struct {
	suite.Suite
}

func TestBigQueryShardingSuite(t *testing.T) {
	suite.Run(t, new(BigQueryShardingSuite))
}

func (s *BigQueryShardingSuite) TestShardedTables() {
...
func (s *BigQueryShardingSuite) TestShardedMetrics() {
